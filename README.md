<h1 align="center">Docker Alpine 3.23 + S6 Overlay</h1>
...
<table align="center">
  <tr>
    ...
    <td align="center" width="50%">
      <a href="https://hub.docker.com/r/samtechlab/alpine-3.23-s6" target="_blank">
...
<p align="center">
<a href="https://hub.docker.com/r/samtechlab/alpine-3.23-s6"><img src="https://img.shields.io/docker/pulls/samtechlab/alpine-3.23-s6?style=for-the-badge&logo=docker"/></a>
<a href="https://hub.docker.com/r/samtechlab/alpine-3.23-s6"><img src="https://img.shields.io/docker/stars/samtechlab/alpine-3.23-s6?style=for-the-badge"/></a>
...
<a href="https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/blob/main/LICENSE" target="_blank"><img src="https://img.shields.io/badge/License-Apache_2.0-blue.svg?style=for-the-badge" alt="License: Apache 2.0"/></a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/actions/workflows/build-multi-arch.yml" target="_blank">
      <img src="https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/actions/workflows/build-multi-arch.yml/badge.svg" alt="Build multi-arch"/>
  </a>
  <a href="https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/actions/workflows/vuln-scan.yml" target="_blank">
      <img src="https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/actions/workflows/vuln-scan.yml/badge.svg" alt="Vulnerability Scan"/>
  </a>
</p>
...
docker run -it --rm ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:latest

# Match the container user to your host user
docker run --rm -e PUID=$(id -u) -e PGID=$(id -g) \
  -v "$PWD/data:/config" \
  ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:latest id appuser
```

Build on top of it:

```dockerfile
FROM ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:latest
...
`FROM scratch` from the **official Alpine OCI rootfs**, with
...
- ✅ **Continuously verified** — hadolint, shellcheck, 12 container integration tests run on
...
|---|---|---|
| GHCR | `ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:latest` | amd64 + arm64 |
| GHCR | `ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:YYYY.MM` | amd64 + arm64 |
| Docker Hub | `samtechlab/alpine-3.23-s6:latest` | amd64 + arm64 |
| Docker Hub | `samtechlab/alpine-3.23-s6:YYYY.MM` | amd64 + arm64 |
...
docker run --rm \
  ...
  -v "$PWD/data:/config" \
  ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:latest \
  sh -c 'id appuser'
```
...
services:
  app:
    image: ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:latest
    security_opt:
...
docker inspect --format '{{json .Config.Labels}}' \
  ghcr.io/sam-tech-lab-oss/alpine-3.23-s6:latest | jq
```

Pin by digest to guarantee byte-for-byte reproducibility:

```bash
docker pull ghcr.io/sam-tech-lab-oss/alpine-3.23-s6@sha256:<digest>
```
...
```bash
cosign verify \
  --certificate-identity-regexp '^https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/\.github/workflows/' \
  --certificate-oidc-issuer 'https://token.actions.githubusercontent.com' \
  ghcr.io/sam-tech-lab-oss/alpine-3.23-s6@sha256:<digest>
```
...
<p align="center">
  <a href="#docker-alpine-323--s6-overlay---sam-tech-lab">English version ↑</a> · <b>Français</b>
</p>
...
- ✅ **Vérifiée en continu** — hadolint, shellcheck, 12 tests d'intégration sur conteneur joués sur
...
- **Les images sont reconstruites chaque mois** (le 1er, à 01h30 UTC) à partir de l'archive
...
- **Les vulnérabilités sont scannées chaque semaine** (lundi, 01h30 UTC) et après chaque build
