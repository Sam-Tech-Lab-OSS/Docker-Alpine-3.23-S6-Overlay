# Alpine 3.23 + s6-overlay

Minimal, hardened, multi-architecture **Alpine 3.23** base image, built `FROM
scratch` from the official Alpine OCI rootfs, with
...
<https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay>
...
```bash
docker pull samtechlab/alpine-3.23-s6@sha256:<digest>
```
...
cosign verify \
  ...
  samtechlab/alpine-3.23-s6@sha256:<digest>
```
...
Also published on GHCR as `ghcr.io/sam-tech-lab-oss/alpine-3.23-s6`.
...
- Continuously verified — hadolint, shellcheck, 12 container integration tests on both
...
in the [full documentation](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay#adding-your-own-services).
...
services:
  app:
    image: samtechlab/alpine-3.23-s6:latest
    security_opt:
...
[SECURITY.md](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/blob/main/SECURITY.md)
...
More entries in the
[full documentation](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay#troubleshooting).
...
Apache 2.0 — see
[LICENSE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/blob/main/LICENSE) and
[NOTICE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/blob/main/NOTICE).
Copyright (c) 2026 Sam Tech Lab.

---
---

# Alpine 3.23 + s6-overlay — version française
...
Également publiée sur GHCR : `ghcr.io/sam-tech-lab-oss/alpine-3.23-s6`.
...
- Vérifiée en continu — hadolint, shellcheck, 12 tests d'intégration sur les deux architectures,
...
[documentation complète](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay#ajouter-vos-propres-services).
...
[documentation complète](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay#dépannage).
...
Apache 2.0 — voir
[LICENSE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/blob/main/LICENSE) et
[NOTICE](https://github.com/Sam-Tech-Lab-OSS/Docker-Alpine-3.23-S6-Overlay/blob/main/NOTICE).
Copyright (c) 2026 Sam Tech Lab.
